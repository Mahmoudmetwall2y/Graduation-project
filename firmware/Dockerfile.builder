...
# Pinned to 2.x: the firmware uses hardware timer APIs (timerAttachInterrupt,
# timerAlarmEnable) that were redesigned in core 3.x.
...
# /sketch  → bind-mounted read-only  (./firmware/asculticor_esp32/)
