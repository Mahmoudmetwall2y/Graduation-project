  ...
  const handleDeleteSession = async () => {
    ...
    try {
      ...
      if (userResp.user) {
        ...
        if (auditError) console.error('Audit log failed (session_deleted):', auditError)
      }
    ...
    return `
      ...
      <body>
        ...
        <div class="disclaimer">
          ...
          professional before any clinical decision is made. AscultiCor is an engineering prototype and is
      ...
      <div className="page-content space-y-6">
        ...
        >
          ...
          <span>
            ...
            AscultiCor is an engineering prototype, not a certified medical device.
          </span>
        </div>
