import { TrendingUp, AlertTriangle, CheckCircle2, Info, FlaskConical } from 'lucide-react'
...
// AAMI classification clinical context
...
/**
 * Model 3 — ECG BiLSTM Predictor: Cardiac Rhythm & Prognosis
 * Displays AAMI-class rhythm classification and clinical risk trajectory.
 */
    ...
    <div className={`rounded-xl border-l-4 ${RISK_BG[aamiClass.risk]} border border-border bg-[var(--hud-surface-glass)] backdrop-blur-md p-6 space-y-5`}>
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="text-lg font-bold text-foreground mt-0.5">Cardiac Rhythm & Prognosis</h3>
          </div>
        </div>
      ...
      {data.demo_mode && (
        <p className="text-xs text-amber-600 dark:text-amber-400 italic">
          ⚠ Demo Mode — Using simulated ECG predictions for this session.
        </p>
      )}
    </div>
  )
